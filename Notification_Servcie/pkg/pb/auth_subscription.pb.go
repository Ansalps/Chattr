...
const file_pkg_pb_auth_subscription_proto_rawDesc = "" +
	...
	"\bBlueTick\x18\a \x01(\bR\bBlueTick\"%\n" +
	...
	"\bBlueTick\x18\x05 \x01(\bR\bBlueTick2\xe3\x01\n" +
	"\x17AuthSubscriptionService\x12a\n" +
	"\x11FetchUserMetaData\x12\x1e.auth_subscription.UserDataReq\x1a,.auth_subscription.BatchUserMetadataResponse\x12e\n" +
...
var file_pkg_pb_auth_subscription_proto_goTypes = []any{
	...
	(*BatchUserMetadataResponse)(nil), // 3: auth_subscription.BatchUserMetadataResponse
...
var file_pkg_pb_auth_subscription_proto_depIdxs = []int32{
	...
	4, // 1: auth_subscription.BatchUserMetadataResponse.UsersEntry.value:type_name -> auth_subscription.UserMetadata
	2, // 2: auth_subscription.AuthSubscriptionService.FetchUserMetaData:input_type -> auth_subscription.UserDataReq
	0, // 3: auth_subscription.AuthSubscriptionService.UserPublicData:input_type -> auth_subscription.UserPublicDataRequest
	3, // 4: auth_subscription.AuthSubscriptionService.FetchUserMetaData:output_type -> auth_subscription.BatchUserMetadataResponse
	1, // 5: auth_subscription.AuthSubscriptionService.UserPublicData:output_type -> auth_subscription.UserPublicDataResponse
