...
const file_pkg_pb_auth_subscription_proto_rawDesc = "" +
	"\n" +
	"\x1epkg/pb/auth_subscription.proto\x12\x11auth_subscription\"E\n" +
	...
	"\n" +
	"UserSignUp\x12$.auth_subscription.UserSignUpRequest\x1a%.auth_subscription.UserSignUpResponseB\n" +
