...
func ConnectDatabase(cfg *config.Config) (*gorm.DB, error) {
	connectionString := fmt.Sprintf("port=%s host=%s user=%s password=%s dbname=%s port=%s sslmode=require",
	...
	err = db.AutoMigrate(&domain.Post{}, &domain.PostMedia{},&domain.PostLike{},&domain.Comment{},
		&domain.Relation{},&domain.Celebrity{},&domain.Follow_Count{})
	if err != nil {
